 ...
 * Generated at: 2023-09-22 08:48:21 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("	function idCheck(param) {\r\n");
      out.write("	    $.ajax({\r\n");
      out.write("	        type: 'POST',\r\n");
      out.write("	        url: 'idCheck.json',\r\n");
      ...
      out.write("	};\r\n");
      out.write("	\r\n");
      out.write("	function join(params) {\r\n");
      out.write("		$.ajax({\r\n");
      out.write("	        type: 'POST',\r\n");
      out.write("	        url: 'join.json',\r\n");
      out.write("	        dataType: 'json',\r\n");
      ...
      out.write("			const param = {id};\r\n");
      out.write("			if(id === '') {\r\n");
      out.write("				alert('아이디를 입력해주세요.');\r\n");
      out.write("				$('#id').focus();\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			idCheck(param);\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      ...
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			const pw = $('#pw').val();\r\n");
      out.write("			if(pw === '') {\r\n");
      out.write("				alert('비밀번호를 입력해주세요.');\r\n");
      out.write("				$('#pw').focus();\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			const pw2 = $('#pw2').val();\r\n");
      out.write("			if(pw2 === '') {\r\n");
      ...
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			const nickname = $('#nickname').val();\r\n");
      out.write("			if(nickname === '') {\r\n");
      out.write("				alert('닉네임을 입력해주세요.');\r\n");
      out.write("				$('#nickname').focus();\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			const params = {id, pw, nickname};\r\n");
 ...
 if (session.getAttribute("id") == null) { 
      ...
      out.write("		<input id=\"check\" type=\"button\" value=\"ID 확인\">\r\n");
      out.write("		</td></tr>\r\n");
      out.write("		\r\n");
      out.write("		<tr id=\"success\"><td colspan=\"2\">사용가능한 아이디입니다.</td></tr>\r\n");
      out.write("		<tr id=\"fail\"><td colspan=\"2\">사용불가능한 아이디입니다.</td></tr>\r\n");
      out.write("		<tr><th>비밀번호</th><td><input type=\"password\" name=\"pw\" id=\"pw\"></td></tr>\r\n");
      out.write("		<tr><th>비밀번호 확인</th><td><input type=\"password\" name=\"pw2\" id=\"pw2\"></td></tr>\r\n");
      out.write("		<tr><th>닉네임</th><td><input type=\"text\" name=\"name\" id=\"nickname\"></td></tr>\r\n");
      out.write("		<tr><td colspan=\"2\"><input id=\"submit\" type=\"button\" value=\"가입하기\"></td></tr>\r\n");
      out.write("	</table>\r\n");
      out.write("</form>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
